...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public TravelerAction GetActionMenuChoice(Menu menu)
        {
            ...
            //
            // create an array of valid keys from neu dictionary
            //
            char[] validKeys = menu.MenuChoices.Keys.ToArray();

            //
            // validate key pressed as in MenuChooices dictipary
            //
            char keyPressed;
            do
            {
        ...
        /// <summary>
        /// Display List of spaceTimeLocations
        /// </summary>
        public void DisplayListOfSpaceTimeLocation()
        {
        ...
        /// <summary>
        /// Get the nect space time Location Id from the user
        /// </summary>
        /// <returns></returns>
        public int DisplayGetNextSpaceTimeLocation()
        {
            ...
            while (!validSpaceTimeLocationId)
            {
                ...
                if (_gameUniverse.IsValidSpaceTimeLocationId(spaceTimeLocationId))
                {
                    ...
                    {
                        ClearInputBox();
                        DisplayInputErrorMessage("It appears you are attempting to travel to an inaccessible location. Please try agian.");
                    }
                }
                else
                {
